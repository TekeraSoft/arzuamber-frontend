...
export const products: Product[] = [
  {
    ...
    sizes: ["36", "38", "40", "42"],
    colors: [
      { name: "Red", imageUrl: "/images/product/product1-1.JPG" },
      { name: "Green", imageUrl: "/images/product/product1-2.JPG" },
      { name: "Blue", imageUrl: "/images/product/product1-3.JPG" },
    ],
    images: [
      "/images/product/product1-1.JPG",
      "/images/product/product1-2.JPG",
      "/images/product/product1-3.JPG",
    ],
    reviews: [
      {
  ...
  },
  {
    ...
    sizes: ["36", "38", "40", "42"],
    colors: [
      { name: "Red", imageUrl: "/images/product/product2-1.JPG" },
      { name: "Green", imageUrl: "/images/product/product2-2.JPG" },
      { name: "Blue", imageUrl: "/images/product/product2-3.JPG" },
    ],
    images: [
      "/images/product/product2-1.JPG",
      "/images/product/product2-2.JPG",
      "/images/product/product2-3.JPG",
    ],
    reviews: [
      {
        id: "64ae4e5f2c99a9e6b3e1f1c9",
  ...
  },
  {
    ...
    sizes: ["36", "38", "40", "42"],
    colors: [
      { name: "Red", imageUrl: "/images/product/product1-3.JPG" },
      { name: "Green", imageUrl: "/images/product/product3-2.JPG" },
      { name: "Blue", imageUrl: "/images/product/product3-3.JPG" },
    ],
    images: [
      "/images/product/product3-1.JPG",
      "/images/product/product3-2.JPG",
      "/images/product/product3-3.JPG",
    ],
    reviews: [
      {
        id: "64ae4e5f2c99a9e6b3e1f1c9",
