  ...
  return (
    <div className="flex flex-col justify-start w-full items-start">
      ...
      <div className="flex flex-wrap gap-3 justify-start items-center w-full">
        ...
        <button
          onClick={handleCopy}
          className="p-2 rounded-full border border-gray-400 bg-gray-100 text-gray-600 hover:bg-gray-200 hover:border-gray-500 hover:text-gray-800 transition duration-300 shadow-sm transform hover:scale-105"
        >
          <BsLink45Deg size={20} />
        </button>
        ...
        <WhatsappShareButton url={editedShareUrl} title={fullTitle}>
          <div className="p-2 rounded-full bg-green-500 text-white hover:bg-green-600 transition duration-300 shadow-md transform hover:scale-105">
            <FaWhatsapp size={20} />
          </div>
        </WhatsappShareButton>
        ...
        <FacebookShareButton
          ...
          hashtag={hashtag}
        >
          <div className="p-2 rounded-full bg-blue-600 text-white hover:bg-blue-700 transition duration-300 shadow-md transform hover:scale-105">
            <FaFacebook size={20} />
          </div>
        </FacebookShareButton>
        ...
        <TwitterShareButton url={editedShareUrl} title={title} via={fullTitle}>
          <div className="p-2 rounded-full bg-black text-white hover:bg-gray-900 transition duration-300 shadow-md transform hover:scale-105">
            <FaXTwitter size={20} />
          </div>
        </TwitterShareButton>
        ...
        <TelegramShareButton url={editedShareUrl}>
          <div className="p-2 rounded-full bg-blue-500 text-white hover:bg-blue-600 transition duration-300 shadow-md transform hover:scale-105">
            <FaTelegram size={20} />
          </div>
        </TelegramShareButton>
      </div>
