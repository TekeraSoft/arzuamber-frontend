...
function SpecialCarts() {
  ...
  const cardData = [
    {
      id: 1,
      icon: <FaShippingFast className="text-2xl sm:text-3xl text-green-600" />,
    ...
    {
      id: 3,
      icon: <FaGift className="text-2xl sm:text-3xl text-red-600" />,
    ...
    {
      id: 3,
      icon: <FaCreditCard className="text-2xl sm:text-3xl text-blue-600" />,
    ...
    {
      id: 4,
      icon: <FaMoneyBillAlt className="text-2xl sm:text-3xl text-yellow-600" />,
      title: "Kapıda Ödeme",
    ...
    {
      id: 5,
      icon: <FaExchangeAlt className="text-2xl sm:text-3xl text-purple-600" />,
      title: "Kolay İade",
    ...
    {
      id: 6,
      icon: <FaMoneyBillAlt className="text-2xl sm:text-3xl text-gray-600" />,
        ...
        {cardData.map((card, index) => (
          ...
          >
            <div className="flex justify-center items-center gap-2">
              ...
              {/* Başlık */}
              <h3 className="text-[10px] sm:text-[11px] md:text-sm font-semibold text-center w-full truncate">
                {card.title}
              </h3>
            </div>
