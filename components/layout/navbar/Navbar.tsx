    ...
    <header className="text-mywhite z-50 fixed w-full ">
      ...
      <nav className="bg-white  w-full  flex  ">
        <div className="container mx-auto flex  items-center justify-between px-4 py-3">
          ...
          <div className="lg:hidden flex items-center justify-center gap-4 ">
            ...
            >
              {!session ? (
                  ...
                  >
                  <span
                      className="gap-1 border border-primary rounded-full text-xs  px-2 py-1 hover:bg-secondary hover:text-mywhite hover:border-slate-200 transition-all duration-300">
                    {t("menuItems.login")}
                  </span>
                  </button>
          ...
          <ul
              className={`hidden text-md  w-1/2 md:flex flex-row justify-center items-center gap-1   `}
          >
            {navLinks.map((link) => (
                <Link
                    key={link.url}
                ...
                >
                  <li
                      ...
                      className={`flex flex-col text-primary hover:bg-secondary hover:text-mywhite transition-all duration-300 justify-start items-center p-1 w-full rounded-lg 
              }`}
                  >
                    {link.name}
                  </li>
