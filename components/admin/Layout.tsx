                    ...
                    <div className={'flex flex-col w-full'}>
                        <Menubar className={'sticky w-full top-0 z-50'} style={{paddingRight:35}} start={()=>
                            ...
                            <span className={'flex flex-row items-center gap-x-2'}>
                                ...
                                <Link href={path} locale={'en'} className={`${locale === 'en' ? 'bg-blue-600 text-white rounded':'border rounded'} p-1`}>EN</Link>
                            </span>
                            <FaUser size={28} color={'gray'} />
                            <BiLogOut className={'cursor-pointer'} onClick={()=> signOut()} size={32} color={'red'} />
                        </span>
                        )} />
