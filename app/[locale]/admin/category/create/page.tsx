...
import {createCategoryDispatch, getCategoriesDispatch} from "@/store/adminSlice";
...
function AdminCreateCategory() {
  ...
  return (
      <div className="flex flex-col items-center justify-center">
          <h3 className="text-gray-500 font-bold text-xl text-center">Tour Category</h3>
          <Formik
              initialValues={{
                  categoryName: "",
          ...
          >
              ...
              <span className="p-float-label">
                <InputText
                    ...
                    onChange={(e) =>
                        setCategoryInput({...categoryInput, subCategoryName: e.target.value})
                    }
                    className="px-4 text-md w-full"
                />
                ...
                />
                      ...
                      <div className="flex items-center w-full justify-center">
                          <Button loading={loading} type="submit"
                                  ...
                                  onClick={() => handleSubmit()}>Güncelle</Button>
                      </div>
                  </>
              )}
          </Formik>
